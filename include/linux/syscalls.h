...
asmlinkage long sys_dentry_info(char* dentry_path, size_t dentry_path_len, struct cstm_dentry_info *dentry_info_ptr);


asmlinkage long sys_lsmod_info(struct cstm_lsmod_module_info* modules_ptr, char** references);
asmlinkage long sys_lsmod_amount_modules(long* modules_amount);
